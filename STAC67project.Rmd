...
#Conclusion
The goal of this case study is to derive a model which best predicts the median value of owner occupied homes in the city of Boston, based on the given dataset.
